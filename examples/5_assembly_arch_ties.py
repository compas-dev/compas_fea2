...
model.author = 'FR'
model.description = 'arch assembly tied together'
...
problem = Problem(name='arch_assembly_static', model=model)
problem.author = 'FR'
problem.description = 'static analysis with gravity and point loads'
...
problem.add_point_load(name='load_point', z=-1, nodes=[0, 3, 4, 7], part=f'block-{int(n/2)}', step='step_pload_1')
