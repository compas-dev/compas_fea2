...
from compas_fea2.backends.abaqus import BucklingStep
...
guid = rs.ObjectsByLayer('elset_mesh')[0]
...
mdl.analyse_and_extract(fields=['u', 's'], components=['ux', 'uy', 'uz', 'um', 'smaxp', 'sminp'])
