...
class AnsysPin2DConstraint(Pin2DConstraint):
    """Ansys implementation of :class:`compas_fea2.model.constraints.Pin2DConstraint`.\n
    """
...
class AnsysPin3DConstraint(Pin3DConstraint):
    """Ansys implementation of :class:`compas_fea2.model.constraints.Pin3DConstraint`.\n
    """
...
class AnsysSliderConstraint(SliderConstraint):
    """Ansys implementation of :class:`compas_fea2.model.constraints.SliderConstraint`.\n
    """
