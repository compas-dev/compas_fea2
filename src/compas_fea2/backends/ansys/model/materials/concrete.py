...
class AnsysConcrete(Concrete):
    """Ansys implementation of :class:`compas_fea2.model.materials.concrete.Concrete`.\n
    """
...
class AnsysConcreteDamagedPlasticity(ConcreteDamagedPlasticity):
    """Ansys implementation of :class:`compas_fea2.model.materials.concrete.ConcreteDamagedPlasticity`.\n
    """
    __doc__ += ConcreteDamagedPlasticity.__doc__

    def __init__(self, *, E, v, density, damage, hardening, stiffening, name=None, **kwargs):
        super(AnsysConcreteDamagedPlasticity, self).__init__(E=E, v=v, density=density, damage=damage, hardening=hardening, stiffening=stiffening, name=name, **kwargs)
        raise NotImplementedError
...
class AnsysConcreteSmearedCrack(ConcreteSmearedCrack):
    """Ansys implementation of :class:`compas_fea2.model.materials.concrete.ConcreteSmearedCrack`.\n
    """
    __doc__ += ConcreteSmearedCrack.__doc__

    def __init__(self, *, E, v, density, fc, ec, ft, et, fr=[1.16, 0.0836], name=None, **kwargs):
        super(AnsysConcreteSmearedCrack, self).__init__(E=E, v=v, density=density, fc=fc, ec=ec, ft=ft, et=et, fr=fr, name=name, **kwargs)
        raise NotImplementedError
