...
class AnsysOptimisationConstraint(OptimisationConstraint):
    """Ansys implementation of :class:`compas_fea2.optimisation.constraints.OptimisationConstraint`.\n
    """
    __doc__ += OptimisationConstraint.__doc__

    def __init__(self, design_response, relative=False, name=None, **kwargs):
        super(AnsysOptimisationConstraint, self).__init__(design_response=design_response, relative=relative, name=name, **kwargs)
