...
class AnsysObjectiveFunction(ObjectiveFunction):
    """ Ansys implementation of :class:`.ObjectiveFunction`.\n
    """
    __doc__ += ObjectiveFunction.__doc__

    def __init__(self, design_response, target, name=None, **kwargs):
        super(AnsysObjectiveFunction, self).__init__(
            design_response=design_response, target=target, name=name, **kwargs)
