...
class AnsysFieldOutput(FieldOutput):
    """ Ansys implementation of :class:`.FieldOutput`.\n
    """
    __doc__ += FieldOutput.__doc__

    def __init__(self, node_outputs, element_outputs, name=None, **kwargs):
        super(AnsysFieldOutput, self).__init__(node_outputs=node_outputs,
                                               element_outputs=element_outputs, name=name, **kwargs)
...
class AnsysHistoryOutput(HistoryOutput):
    """ Ansys implementation of :class:`.HistoryOutput`.\n
    """
