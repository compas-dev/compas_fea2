...
from compas_fea2.problem.steps.step import Step
...
class Problem(FEAData):
    """A Problem is a collection of analysis steps (:class:`compas_fea2.problem.Step)
    ...
    Warnings
    --------
    Factore Steps are new objects! check the :class:`compas_fea2.problem.Step
    documentation.
    ...
    def add_step(self, step):
        # # type: (Step) -> Step
        """Adds a :class:`compas_fea2.problem.Step` to the problem. The name of
...
""".format(
    ...
    def store_results_in_model(self, database_path=None, database_name=None, steps=None, fields=None, *args, **kwargs):
        ...
        steps : :class:`compas_fea2.problem.Step`, optional
